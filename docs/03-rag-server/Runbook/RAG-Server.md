...
向量检索 (/api/rag/query) - 从知识库中检索相关文档
AI 问答 (/api/askai) - 使用 LLM 生成答案
文档索引 (/api/rag/upsert) - 向知识库添加文档
依赖服务
...
2. 创建 Pull Request
访问 GitHub 仓库
创建 PR: feature/your-feature-name → 
main
等待 CI/CD 检查通过
请求代码审查
合并到 main 分支
...
验证配置文件中的 models.generator.endpoint 不为空
修复代码:
